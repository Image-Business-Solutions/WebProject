...
<body>
    <div class="welcome">
        ...
        <?php 
        echo Form::open(array('action' => 'ReportController@showFullReport', 'method' => 'get')) ;
            echo Form::select('place', $places).Form::selectMonth('date');
            echo Form::submit('Show full report');            
        echo Form::close();

        echo Form::open(array('action' => 'ReportController@showReport', 'method' => 'get')) ;
            echo Form::select('company', $companies).Form::selectMonth('date');
            echo Form::submit('Show simple report');            
        echo Form::close(); 
        ?>
    </div>
</body>
